...
const Page2 = () => {   
    ...
    useGSAP(function(){
        ...
        gsap.from(".rotateText", {
           ...
           opacity: 0,
           duration: function() {
            return window.matchMedia('(max-width: 768px)').matches ? .5 : 1;
          },
           stagger: 2,
           scrollTrigger: {
            trigger: ".rotateText",
           //markers: true,
           start: isMobile ? "top 80%" : "top 70%", // Different start for mobile and web
           end: isMobile ? "top 20%" : "top -300%", // Different end for mobile and web
           scrub: isMobile ? 2 : 3, // Different scrub value for mobile and web
          }
        })       
    })

  return (
    <div id='section2' className='bg-red-200 text-center text-black'>
        <h3 className='text-gray-500 text-sm sm:text-xl  font-[anzo3] bg-red-200 '>© shivam.pbd 2025 | designed and developed</h3>
        <div className='rotateText mt-10 sm:mt-20'>
            <h1 className='text-[36vw] sm:text-[41vw]  text-black font-[anzo5] uppercase leading-[20vw] sm:leading-[33vw]'>IMPACTFUL</h1>
        </div>
        <div className='rotateText mt-10 sm:mt-3'>
        <h1 className='text-[36vw] sm:text-[41vw]  text-black font-[anzo5] uppercase leading-[20vw] sm:leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText mt-10 sm:mt-3'>
            <h1 className='text-[36vw] sm:text-[41vw]  text-black font-[anzo5] uppercase leading-[24vw] sm:leading-[33vw]'>IS THE</h1>
        </div>
        <div className='rotateText mt-10 sm:mt-3'>
            <h1 className='text-[36vw] sm:text-[41vw]  text-black font-[anzo5] uppercase leading-[24vw] sm:leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText mt-10 sm:mt-3'>
            <h1 className='text-[36vw] sm:text-[41vw]  text-black font-[anzo5] uppercase leading-[24vw] sm:leading-[33vw]'>THAT</h1>
        </div>
        <div className='rotateText relative  mt-10 sm:mt-3'>
            <h1 className='text-[36vw] sm:text-[41vw]  text-black font-[anzo5] uppercase leading-[24vw] sm:leading-[33vw]'>WORKS!</h1>
        </div>
    ...
    <g>
        ...
        <div className='h-1 w-1/3 relative left-1/2 -translate-x-1/2 mt-16 bg-black'>
